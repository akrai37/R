...
p + 
  geom_boxplot()# " + scale_size_area(max_size = 2)" this code can be used to reduce the siz of the dots in our graph.
...
q$labels$size = "Budget $Mi"
q

#Note: To change the column name of one column OR row in the dataset :-
#colnames(your_object)[k] <- new_column_name
#names(your_object)[k] <- new_name
#rownames(your_object)[k] <- new_row_name
#Above process can be repeated to change further columns or row names.
